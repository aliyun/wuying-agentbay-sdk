...
class TestExtension(unittest.TestCase):
    ...
    def test_extension_str_representation(self):
        """Test Extension string representation."""
        ext = Extension(id="ext_123", name="test-extension.zip")
        str_repr = str(ext)
        
        self.assertIn("test-extension.zip", str_repr)
        self.assertIn("ext_123", str_repr)
...
class TestExtensionIntegration(unittest.TestCase):
    ...
    def test_full_extension_workflow(self, mock_put, mock_open, mock_exists):
        ...
        mock_file_entry.file_name = "ext_123.zip"
        mock_file_entry.gmt_create = "2024-01-01T00:00:00Z"
        
        mock_list_result = Mock()
        mock_list_result.success = True
        mock_list_result.entries = [mock_file_entry]
