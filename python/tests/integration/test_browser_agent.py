...
os.environ["AGENTBAY_API_KEY"]="akm-2aec8894-3a2e-4275-8299-a02e596c6552"
os.environ["AGENTBAY_REGION_ID"] = "cn-hangzhou"
os.environ["AGENTBAY_ENDPOINT"] = "wuyingai-pre.cn-hangzhou.aliyuncs.com"
os.environ["AGENTBAY_TIMEOUT_MS"] = "30000"
    ...
    def test_polling_proxy_multiple_ips(self):
        ...
        for i in range(5):
            ...
            try:
                ...
                if not ip:
                    # 如果JavaScript解析失败，尝试获取页面内容并用正则表达式提取
