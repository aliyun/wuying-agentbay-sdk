...
class BrowserProxy:
    ...
    Supports three types of proxy: custom, wuying-restricted, wuying-polling.
    """
    def __init__(
        self,
        ...
        Args:
            ...
            strategy: Strategy for wuying proxy - "restricted" or "polling"
            pollsize: Pool size for polling strategy (default: 10)
        """
